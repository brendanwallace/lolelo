...
def setup():
    ...
    spring_2017, _ = core_models.Season.objects.get_or_create(
        date=datetime.date(2017, 1, 1), name="Spring 2017")
    summer_2017, _ = core_models.Season.objects.get_or_create(
    ...
    for season, results in [
        ...
        for week_index, week in enumerate(results):
            for team_1, team_2, wins_1, wins_2 in week:
                ...
                match, _ = core_models.Match.objects.get_or_create(
